...
url = "https://marketplace.visualstudio.com/_apis/public/gallery/publishers/GitHub/extensions/copilot/reviews"
headers = {
...
df.to_excel("data/GitHub Copilot [09.07.2025].xlsx", index=False)
print(f"✅ Finished. Total {len(all_reviews)} reviews saved to GitHub Copilot [09.07.2025].xlsx")

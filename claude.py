...
url = "https://marketplace.visualstudio.com/_apis/public/gallery/publishers/anthropic/extensions/claude-code/reviews"
headers = {
...
df.to_excel("data/Claude Code for VSCode [09.07.2025].xlsx", index=False)
print(f"✅ Finished. Total {len(all_reviews)} reviews saved to Claude Code for VSCode [09.07.2025].xlsx")
